...
display:flex;
--------------
When we have to arrange the boxes in horizontal manner then we will use the dispaly: flex; Here the boxes will take the maximum height among the three boxes.
